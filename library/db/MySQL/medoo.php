...
class medoo
{
	...
	{
		return '' . str_replace('.', '"."', preg_replace('/(^#|\(JSON\)\s*)/', '', $string)) . '';//TODO将双引号去除
	}
	...
	{
		$table = '' . $this->prefix . $table . '';//TODO 将双引号去除
	...
	public function insert($table, $datas)
	{
		...
		foreach ($datas as $data)
		{
			...
			$this->exec('INSERT INTO ' . $this->prefix . $table . ' (' . implode(', ', $columns) . ') VALUES (' . implode($values, ', ') . ')');//TODO 将双引号去除
	...
	public function update($table, $data, $where = null)
	{
		...
		return $this->exec('UPDATE ' . $this->prefix . $table . ' SET ' . implode(', ', $fields) . $this->where_clause($where));//TODO 将双引号去除
	}

	public function delete($table, $where)
	{
		return $this->exec('DELETE FROM ' . $this->prefix . $table . $this->where_clause($where));//TODO 将双引号去除
	}
	...
	public function replace($table, $columns, $search = null, $replace = null, $where = null)
	{
		...
		return $this->exec('UPDATE ' . $this->prefix . $table . ' SET ' . $replace_query . $this->where_clause($where));//TODO 将双引号去除
	}
